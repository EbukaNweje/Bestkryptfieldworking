...
if (null !== mainNav) {
    ...
    t.forEach(function(e) {
        e.classList.remove("uk-nav", "uk-navbar-dropdown-nav"),
            ...
            n(e.parentElement),
            null !== e.querySelector("a.uk-disabled") && (n(e.parentElement.parentElement), n(e.parentElement), e.querySelector("a.uk-disabled").parentElement.parentElement.remove());
    });
    const a = document.querySelector(".in-optional-nav");
    let r = "";
    null !== a &&
        a.children.length > 0 &&
        (r = `<a href="https://app.assetsgeniusvip.com/login" class="uk-button uk-button-primary uk-border-rounded uk-align-center">Melody<i class="fas fa-sign-in-alt uk-margin-small-left"></i></a>`);
...
function iframeVid(e) {
    for (var t in ((this.defaults = { selector: ".in-iframe", url: "", width: 900, height: 506 }), (this.props = {}), this.defaults))
        void 0 !== t && ((this.props[t] = this.defaults[t]), e.hasOwnProperty(t) && this.props.hasOwnProperty(t) && (this.props[t] = e[t]));
            ...
            t.addEventListener("click", (t) => {
                ...
                ajaxRequest("POST", "sendmail.html", serialize(document.getElementById("contact-form")), (t, n) => {
                    if (t) {
                        ...
                        t.isSuccess ?
                            (UIkit.notification("<i class='fas fa-check-circle uk-margin-small-right'></i> Your message has been sent successfully. Thank you!", { timeout: 3e3, status: "primary", pos: "bottom-right" }), e.reset()) :
