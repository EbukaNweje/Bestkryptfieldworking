...
ukbutton.onclick = (e) => {
    ...
    if(!FirstName.value || !checkbox.value ||  !LastName.value || !username.value || !captchaBox.value || !Emails.value ||  !Seletor.value || !MobileCode.value  || !PhoneNumber.value || !Password.value || !confirmationPassWord.value){
