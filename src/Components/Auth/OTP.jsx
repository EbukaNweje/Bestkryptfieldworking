...
const OTP = () => {
  ...
  const url = `https://newbestkryptfieldbackend.onrender.com/api/verifyotp/${verifyid}`
  const url2 = `https://newbestkryptfieldbackend.onrender.com/api/resetotp/${verifyid}`
